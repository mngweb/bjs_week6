...
var _EventEmitter2 = __webpack_require__(28);
...
var Database = function (_EventEmitter) {
    (0, _inherits3.default)(Database, _EventEmitter);
    ...
    function Database(url) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (Database.__proto__ || (0, _getPrototypeOf2.default)(Database)).call(this));
...
console.log("Czy to ten sam obiekt?:", (0, _is2.default)(_EventEmitter2.default, _Database.EventEmitter));
...
// TEST:
var ev = new _Database.EventEmitter();
...
ev.on("goodbye", function (message) {
...
var url = "db://localhost:3000";

var db = new _Database2.default(url); // fikcyjny adres
